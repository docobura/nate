...
import GroupDetailsComponent from '../(tabs)/groupdetail';
    ...
    const handleTabPress = (tabId: string) => {
        ...
        switch (tabId) {
            case 'Home':
                ...
                break;
            case 'Community':
                console.log('📍 Already in Community (Groups) section');
                break;
            case 'Resources':
                console.log('📚 Navigate to Resources');
                // Add navigation logic for Resources if needed
                break;
            default:
    ...
    if (loading) {
        return (
            <View style={styles.pageContainer}>
                ...
                <BottomNavFooter activeTab="Community" onTabPress={handleTabPress} />
            </View>
        );
    }
